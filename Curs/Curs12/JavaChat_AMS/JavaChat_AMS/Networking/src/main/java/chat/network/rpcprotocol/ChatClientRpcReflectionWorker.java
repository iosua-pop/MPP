...
public class ChatClientRpcReflectionWorker implements Runnable, IChatClient {
    ...
    public void userLoggedIn(User friend) throws ChatException {
        ...
        Response resp=new Response.Builder().type(ResponseType.USER_LOGGED_IN).data(udto).build();
    ...
    public void userLoggedOut(User friend) throws ChatException {
        UserDTO udto=DTOUtils.getDTO(friend);
        Response resp=new Response.Builder().type(ResponseType.USER_LOGGED_OUT).data(udto).build();
